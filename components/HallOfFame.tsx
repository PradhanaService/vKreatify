      ...
      <div className="mx-auto max-w-[1800px]">
        <div className="flex items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] uppercase tracking-[0.15em] text-[#86868B] dark:text-white/45">
              Recent Launches
            </span>
          </div>

          <span className="text-right text-[11px] uppercase tracking-[0.15em] text-[#86868B] dark:text-white/45">
            Work and engagements
          </span>
        </div>

        <div className="pt-24 md:pt-28 lg:pt-[120px]">
          <h2 className="mx-auto max-w-[12ch] text-center text-[clamp(52px,7vw,96px)] font-[300] leading-[1.1] tracking-[-0.03em] text-[#1D1D1F] dark:text-white">
            Hall of Fame
            <span className="ml-2 inline-block h-[10px] w-[10px] rounded-full bg-[#FFD700] align-middle" />
          </h2>

          <p className="mx-auto max-w-[600px] pt-8 text-center text-[17px] leading-[1.7] text-[#6E6E73] dark:text-white/60">
        ...
        <div className="mt-20 grid gap-x-6 gap-y-12 md:grid-cols-2 md:gap-y-14 lg:mt-24">
          ...
          <div className="space-y-12 md:space-y-14 md:pt-0 lg:pt-[120px]">
