...
export default function NextClientBlock({ client }: NextClientBlockProps) {
  return (
    <Link
      ...
      prefetch={true}
      scroll={true}
      className="group relative flex h-[280px] items-center overflow-hidden bg-[#111111] px-[5vw] text-white"
    >
      <div
      ...
      <div className="relative z-10 flex w-full items-center justify-between gap-10">
        <div>
          <p className="mb-3 text-[10px] uppercase tracking-[0.2em] text-white/35 transition-colors duration-300 group-hover:text-white/70">
            Next Project
          </p>
        ...
        <div className="text-[48px] text-white/25 transition-all duration-300 group-hover:translate-x-2 group-hover:text-white">
          &rarr;
        </div>
      </div>
    </Link>
